...
namespace PRM.DataLayer
{
    ...
    public class ENTVWFRMFIRM
    {
        ...
        public ENTVWFRMFIRM(Guid ID, string NAME, string DESCRIPTION, byte CITYID, Int16 DISTRICTID, string ADDRESS, string FIRMCITYNAME, string FIRMDISTRICTNAME)
        {
            this.ID = ID;
            this.NAME = NAME;
