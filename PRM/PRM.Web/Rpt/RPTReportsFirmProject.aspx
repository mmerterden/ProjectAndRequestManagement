<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPTReportsFirmProject.aspx.cs" Inherits="PRM.Web.Rpt.RPTReportsFirmProject" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="icon_piechart"></i>Proje Raporu</h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class="icon_piechart"></i>Proje Raporu</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <section class="panel">
                                ...
                                <asp:Repeater ID="rptProjectReport" runat="server">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="col-xs-4"><i class="fa fa-suitcase"></i>&nbsp Proje Adı</th>
                                                    <th class="col-xs-3"><i class="fa fa-spinner"></i>&nbsp Proje Durumu</th>
                                                    <th class="col-xs-3"><i class="fa fa-adjust"></i>&nbsp Açık/Kapalı</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href='RPTReportsFirmTask.aspx?ID=<%#Eval("PROJECTID") %>' class="btn btn-info"><i class="fa fa-info-circle"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
