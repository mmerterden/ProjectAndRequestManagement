<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJMyTasks.aspx.cs" Inherits="PRM.Web.Prj.PRJMyTasks" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row ">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-tasks"></i>Görevlerim<meta charset="utf-8" /></h3>

                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="/Default.aspx">Ana Sayfa</a></li>
                                <li><i class=""></i>Görevlerim</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row FS12">
                                ...
                                <asp:Repeater ID="rptTasks" runat="server">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    <th><i class="fa fa-building"></i>&nbsp Firma Adı</th>
                                                    <th><i class="fa fa-suitcase"></i>&nbsp Proje Adı</th>
                                                    <th><i class="fa fa-spinner"></i>&nbsp Proje Durumu</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href='/Prj/PRJProjectTaskResourseDetail.aspx?ID=<%#Eval("PROJECTTASKID") %>' class="btn btn-info"><i class="fa fa-info-circle"></i></a>
                                                    <a href='/Prj/PRJProjectMyTasksActivityAdd.aspx?ID=<%#Eval("PROJECTTASKRESOURSEID")%>' class="btn btn-warning"><i class="fa fa-clock-o"></i></a>
                                                    <a href='/Prj/PRJMyActivity.aspx?ID=<%#Eval("PROJECTTASKRESOURSEID")%>' class="btn btn-info"><i class="fa fa-list"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
