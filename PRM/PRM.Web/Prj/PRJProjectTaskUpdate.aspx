<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJProjectTaskUpdate.aspx.cs" Inherits="PRM.Web.Prj.PRJProjectTaskUpdate" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                   <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-suitcase"></i>Proje Görev Güncelleme<meta charset="utf-8" /></h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-file-text-o"></i><a href='/Prj/PRJProjectTaskResourseDetail.aspx?ID=<%=PROJECTTASKID%>'>Görev Detayı</a></li>
                                <li><i class=""></i>Proje Görev Güncelleme</li>
                            </ol>
                        </div>
                    </div>
                                                     ...
                                                     <div class="col-xs-12">
                                                         ...
                                                         <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                             ...
                                                             <asp:DropDownList ID="drpStatus"  CssClass="form-control" runat="server">
                                                                   ...
                                                                   <span class="input-group-addon"><i class="ace-icon fa fa-sort bigger-120"></i></span>
                                                                   </div>
                                                         </div>
                                                           
                                                        <asp:UpdatePanel ID="updPanl1" ChildrenAsTriggers="true" runat="server" RenderMode="Block" UpdateMode="Conditional">
                                                              <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="btnCal1" EventName="Click" />
                                                            </Triggers>
                                                             <ContentTemplate>
                                                         <label for="cname" class="control-label col-lg-1 col-md-2 col-sm-2 MT10">Bitiş Tarihi</label>
                                                         <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                             <div class="input-group input-icon input-icon-right padding-right-2n">
                                                                 <asp:TextBox ID="txtDueDate" runat="server" onclick="hide1(event)" MaxLength="50" CssClass="form-control" onKeyPress="return nothing(event)"></asp:TextBox>
                                                                 <span class="input-group-addon"  onmouseup="hide1(event)"><i class="ace-icon fa fa-calendar-o bigger-120"></i></span>
                                                                 <asp:Button ID="btnCal1" OnClick="btnCal1_Click" Style="display: none" runat="server" />
                                                             </div>
                                                             <asp:Calendar ID="CalDate1" runat="server" OnSelectionChanged="CalDate_SelectionChanged"  BackColor="White" WeekendDayStyle-BackColor="#E1E1E1" WeekendDayStyle-BorderColor="Black" SelectorStyle-BackColor="White" SelectedDayStyle-BackColor="#0099FF" SelectionMode="DayWeekMonth"></asp:Calendar>
                                                         </div>
                                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>      
                                                     </div>
                                            ...
                                            <div class="form-group MT10">
                                                <div class="col-lg-12">
                                                    <div class="pull-right">
                                                        ...
                                                        <asp:LinkButton ID="btnUpdate" onclick="btnUpdate_Click" runat="server" CssClass="btn btn-primary"><i class="fa fa-pencil-square-o"></i>&nbsp;Güncelle</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
