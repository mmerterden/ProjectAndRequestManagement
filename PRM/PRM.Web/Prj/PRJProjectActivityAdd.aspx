<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJProjectActivityAdd.aspx.cs" Inherits="PRM.Web.Prj.PRJProjectActivityAdd" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-clock-o"></i>Aktivite<meta charset="utf-8" /></h3>

                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="/Default.aspx">Ana Sayfa</a></li>
                                <li><i class="fa fa-tasks"></i>Görevlerim</li>
                                <li><i class=""></i>Aktivite</li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-11 col-md-10 col-sm-10 MT10">
                                                            <label class="form-control">Proje Yönetimi - RUNHRPM</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br/>
                                                     ...
                                                     <div class="col-xs-12">
                                                         ...
                                                         <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                             <div class="input-group input-icon input-icon-right padding-right-2n">
                                                                 <input class="form-control clean-text clean-text-autocomplete ui-autocomplete-input" />
                                                        ...
                                                        <asp:UpdatePanel ID="updPanl" ChildrenAsTriggers="true" runat="server" RenderMode="Block" UpdateMode="Conditional">
                                                            ...
                                                            <ContentTemplate>
                                                         <label for="cname" class="control-label col-lg-1 col-md-2 col-sm-2 MT10">Tarih</label>
                                                         <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                             <div class="input-group input-icon input-icon-right padding-right-2n">
                                                                 ...
                                                                 <span class="input-group-addon" onmouseup="hide(event)" ><i class="ace-icon fa fa-keyboard-o bigger-120"></i></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-11 col-md-11 col-sm-11 WHM">
                                            ...
                                            <div class="form-group MT10">
                                                <div class="col-lg-12">
                                                    <div class="pull-right">
                                                        <asp:LinkButton ID="btnClear" runat="server" CssClass="btn btn-warning"><i class="fa fa-minus-circle"></i>&nbsp;İptal</asp:LinkButton>
                                                        <asp:LinkButton ID="btnAddNew" runat="server" CssClass="btn btn-success"><i class="fa fa-floppy-o"></i>&nbsp;Kaydet</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
