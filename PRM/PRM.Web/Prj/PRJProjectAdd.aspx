<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJProjectAdd.aspx.cs" Inherits="PRM.Web.Prj.PRJProjectAdd" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-suitcase"></i>Proje Ekle<meta charset="utf-8" /></h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-building"></i>Proje Ekle</li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form-group MT10">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="pull-right">
                                                        <a class="btn btn-warning" href="/Prj/PRJProjects.aspx?"><i class="fa fa-minus-circle"></i>&nbsp;İptal</a>
