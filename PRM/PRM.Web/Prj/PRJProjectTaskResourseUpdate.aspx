<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJProjectTaskResourseUpdate.aspx.cs" Inherits="PRM.Web.Prj.PRJProjectTaskResourseUpdate" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-user"></i>Kaynak Güncelleme<meta charset="utf-8" /></h3>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Kaynak Güncelleme</li>
                            </ol>
                        </div>
                    </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                            <div class="input-group input-icon input-icon-right padding-right-2n">
                                                                <asp:Label ID="lblProjectTaskName" runat="server" CssClass="form-control"></asp:Label>
