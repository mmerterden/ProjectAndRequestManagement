<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRJProjectMyTasksActivityAdd.aspx.cs" Inherits="PRM.Web.Prj.PRJProjectMyTasksActivityAdd" %>
                                            ...
                                            <div class="form-group MT10">
                                                <div class="col-lg-12">
                                                    <div class="pull-right">
                                                        ...
                                                        <asp:LinkButton ID="btnRecordAndOkey" runat="server" CssClass="btn btn-success" OnClick="btnRecordAndOkey_Click"><i class="fa fa-floppy-o"></i>&nbsp;Kaydet ve Görevi Tamamla</asp:LinkButton>
