<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MNGFirmUpdate.aspx.cs" Inherits="PRM.Web.Mng.MNGFirmUpdate" %>
...
<body>
    <form id="frmMNGFirmUpdate" runat="server">
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-building"></i>Şirket Güncelle<meta charset="utf-8" /></h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Şirket Güncelle</li>
                            </ol>
                        </div>  
                    </div>
                    <div class="row" id="dvMNGFirmUpdate" runat="server">
                        <div class="col-lg-12">
                            <section class="panel">
                                    ...
                                    <div class="form">
                                        <div class="form-validate form-horizontal">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="cname" class="control-label col-lg-1 col-md-2 col-sm-2 MT10"><span class="MT10">İl Adı</span></label>
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                            <asp:DropDownList ID="drpCity" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpCity_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </div>
                                                        <label for="cname" class="control-label col-lg-1 col-md-2 col-sm-2 MT10"><span class="MT10">İlçe</span></label>
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                            <asp:DropDownList ID="drpDistrict" CssClass="form-control" runat="server">
                                                            </asp:DropDownList>
                                                        </div>
