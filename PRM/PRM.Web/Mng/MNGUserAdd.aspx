<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MNGUserAdd.aspx.cs" Inherits="PRM.Web.Mng.MNGUserAdd" %>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-user"></i>Kullanıcı Ekle</h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Kullanıcı Ekle</li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                            <div class="input-group input-icon input-icon-right padding-right-2n">
                                                                ...
                                                                <asp:Label ID="lblFirm" CssClass="form-control" runat="server"></asp:Label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
                                                            <asp:DropDownList ID="drpUserType" CssClass="form-control" runat="server">
                                                            </asp:DropDownList>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <label for="cname" class="control-label col-lg-1 col-md-2 col-sm-2 MT10">Yönetici</label>
                                                        <div class="col-lg-5 col-md-4 col-sm-4 MT10">
